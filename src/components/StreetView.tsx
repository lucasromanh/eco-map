...
export const StreetView = ({ location, isOpen, onClose }: StreetViewProps) => {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-[1500] bg-gray-900 shadow-2xl border-t-4 border-primary-500 transition-all duration-300 ease-in-out" style={{ height: '50vh', maxHeight: '500px' }}>
